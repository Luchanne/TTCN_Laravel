                          ...
                          <tr id="row-{{ $item->id }}">
                              ...
                              <td class="align-middle">
                                  <span id="cartProductPrice{{ $item->id }}">
                                      {{ number_format($item->product->sale ? $item->product->sale_price * $item->product_quantity : $item->product->price * $item->product_quantity) }}đ</span>

                              </td>
                              <td class="align-middle">
                                  <button class="btn btn-sm btn-primary btn-delete btn-remove-product"
                                      data-action="{{ route('client.carts.remove_product', $item->id) }}"  data-id="{{ $item->id }}"><i
          ...
          <div class="col-lg-4">
              ...
              <div class="card border-secondary mb-5">
                  ...
                  <div class="card-footer border-secondary bg-transparent">
                      ...
                      <a href="{{ route('client.checkout.index') }}" class="btn btn-block btn-primary my-3 py-3">Thanh toán</a>
                  </div>
              </div>
          </div>
      </div>
