...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/dashboard', [DashboardController::class,'index'])->name('dashboard')->middleware('role:super-admin');
    ...
    Route::resource('categories', CategoryController::class)->middleware('role:super-admin');
    Route::resource('products', ProductController::class)->middleware('role:super-admin');
    Route::resource('coupons', CouponController::class)->middleware('role:super-admin');
    Route::get('orders', [AdminOrderController::class, 'index'])->name('admin.orders.index')->middleware('role:super-admin');
    Route::post('update-status/{id}', [AdminOrderController::class, 'updateStatus'])->name('admin.orders.update_status')->middleware('role:super-admin');
});
