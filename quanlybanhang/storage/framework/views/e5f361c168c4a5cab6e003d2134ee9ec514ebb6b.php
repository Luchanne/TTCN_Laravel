            ...
            <div class="row px-xl-5 pb-3">
                <div class="col-lg-4 col-md-6 pb-1">
                    <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                        ...
                        <a href="" class="cat-img position-relative overflow-hidden mb-3">
                            <img class="img-fluid" src="<?php echo e(asset('client/img/cat-1.jpg')); ?>" alt="">
                        </a>
                ...
                <div class="col-lg-4 col-md-6 pb-1">
                    <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                        <p class="text-right">15 sản phẩm</p>
                        <a href="" class="cat-img position-relative overflow-hidden mb-3">
                            <img class="img-fluid" src="<?php echo e(asset('client/img/cat-2.jpg')); ?>" alt="">
                        </a>
                ...
                <div class="col-lg-4 col-md-6 pb-1">
                    <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                        <p class="text-right">15 sản phẩm</p>
                        <a href="" class="cat-img position-relative overflow-hidden mb-3">
                            <img class="img-fluid" src="<?php echo e(asset('client/img/cat-3.jpg')); ?>" alt="">
                        </a>
            ...
            <div class="row px-xl-5">
                ...
                <div class="col-md-6 pb-4">
                    <div class="position-relative bg-secondary text-center text-md-left text-white mb-2 py-5 px-5">
                        <img src="<?php echo e(asset('client/img/offer-2.png')); ?>" alt="">
                        <div class="position-relative" style="z-index: 1;">
                            <h5 class="text-uppercase text-primary mb-3">Giảm 20% cho tất cả hóa đơn</h5>
